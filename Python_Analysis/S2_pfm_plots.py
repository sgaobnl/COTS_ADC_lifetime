...
Last modified: 3/21/2018 1:14:17 PM
"""
...
cur_plot (result_f, plot_f, cur_pcts=irefnor_pct , fn="Current_of_Normal_Vref", dut_no = dut_no, ylim=[98,102])
cur_plot (result_f, plot_f, cur_pcts=iccnor_pct  , fn="Current_of_Normal_Vcc", dut_no = dut_no , ylim=[98,102])
cur_plot (result_f, plot_f, cur_pcts=ivrefstr_pct, fn="Current_of_Stress_Vref", dut_no = dut_no, ylim=[98,102])
cur_plot (result_f, plot_f, cur_pcts=ivccstr_pct , fn="Current_of_Stress_VCC", dut_no = dut_no , ylim=[98,102])
